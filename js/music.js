  function createAudioWithFallback(name) {
    ...
    sourceMP3.src = `../dblox/audio/${name}.mp3`;
    sourceMP3.type = "audio/mpeg";

    sourceOGG.src = `../dblox/audio/${name}.ogg`;
  ...
  function toggleMute() {
    ...
    icon.src = isMuted ? "../dblox/images/mute.png" : "../dblox/images/unmute.png";
  ...
  muteBtn.id = "muteIcon";
  muteBtn.src = "../dblox/images/unmute.png";
